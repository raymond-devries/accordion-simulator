...
def run_simulation(print_game: bool = False,
...
def run_multiple_simulations(simulations: int = 10, print_results: bool = False,
                             cost_per_deck: float = 0, earned_per_card: float = 0,
